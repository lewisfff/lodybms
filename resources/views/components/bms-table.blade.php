    ...
    $(document).ready(function () {
        var table = $('.table').DataTable({
            ...
            columns: [
                ...
                {data: 'backbmp', name: 'backbmp', responsivePriority: 1, visible: false},
                {data: 'banner', name: 'banner', responsivePriority: 1, visible: false},
                {data: 'content', name: 'content', responsivePriority: 1, visible: false},
                {data: 'adddate', name: 'adddate', responsivePriority: 1, visible: false},
                {data: 'date', name: 'date', responsivePriority: 0, visible: false,},
                {data: 'difficulty', name: 'difficulty', responsivePriority: 0},
                {data: 'favorite', name: 'favorite', responsivePriority: 0, visible: false},
                {data: 'feature', name: 'feature', responsivePriority: 1},
                {data: 'folder', name: 'folder', responsivePriority: 1, visible: false},
                {data: 'judge', name: 'judge', responsivePriority: 1},
                {data: 'length', name: 'length', responsivePriority: 0},
                {data: 'level', name: 'level', responsivePriority: 0, visible: false},
                ...
                {data: 'parent', name: 'parent', responsivePriority: 1, visible: false},
                {data: 'path', name: 'path', responsivePriority: 1},
                {data: 'preview', name: 'preview', responsivePriority: 1, visible: false},
                {data: 'stagefile', name: 'stagefile', responsivePriority: 1, visible: false},
                {data: 'tag', name: 'tag', responsivePriority: 1, visible: false},
            ]
        });
